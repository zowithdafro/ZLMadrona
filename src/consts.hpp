...
inline constexpr madrona::CountT maxEntitiesPerRoom = 7;
...
// Lava specific constants
inline constexpr float lavaWidth = .3f; // Size of the lava entity
inline constexpr float lavaHeight = .3f; // Collision radius
