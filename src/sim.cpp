...
void Sim::registerTypes(ECSRegistry &registry, const Config &)
{
    ...
    registry.registerComponent<LavaObservation>();
    ...
    registry.exportColumn<Agent, LavaObservation>(
        (uint32_t)ExportID::LavaObservation);
